...
import { User, Building2, Phone, MapPin, FileText, Shield, Camera } from 'lucide-react';
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6 pb-12 animate-in fade-in duration-500">
            <div className="border-b border-subtle pb-6">
                ...
                <p className="text-muted">Manage your supplier profile and business information.</p>
            </div>
