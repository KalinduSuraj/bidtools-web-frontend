...
export default function SupplierRentalDetailPage({ params }: { params: { rentalId: string } }) {
    ...
    if (error) {
        return (
            <div className="max-w-3xl mx-auto py-12">
                ...
                <Link href="/supplier/orders" className="mt-4 inline-block text-primary hover:underline">&larr; Back to Orders</Link>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 animate-in fade-in duration-500">
            <Link href="/supplier/orders" className="text-sm text-primary hover:underline flex items-center gap-1 w-fit mb-6">
