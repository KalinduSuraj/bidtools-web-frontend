...
export default function ContractorRentalDetailPage({ params }: { params: Promise<{ rentalId: string }> }) {
                    ...
                    {item && (
                        <div className="bg-surface border border-subtle rounded-2xl p-6 shadow-theme-sm space-y-3">
                            ...
                            <div className="flex justify-between py-2 border-b border-subtle/50">
                                ...
                                <span className="text-sm text-main">{item.description || 'N/A'}</span>
                            </div>
                            <div className="flex justify-between py-2">
                                <span className="text-sm text-muted">Rate</span>
                                <span className="text-sm font-bold text-primary">${item.price_per_day}/day · ${item.price_per_hour}/hr</span>
                            </div>
                        </div>
                    )}
